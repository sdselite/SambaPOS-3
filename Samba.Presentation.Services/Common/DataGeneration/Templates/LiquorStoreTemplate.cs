...
{
    class LiquorStoreTemplate : IDataTemplate
    {
        ...
        private PrinterTemplate AddDefaultPrintersAndTerminal()
        {
            ...
            var pm1 = new PrinterMap { PrinterId = printer1.Id, PrinterTemplateId = customerReceiptTemplate.Id };
            _workspace.Add(pm1);
        ...
        private void AddDefaultUsers()
        {
            ...
            var cashierRole = new UserRole("Cashier") { IsAdmin = false, DepartmentId = 1 };
            _workspace.Add(cashierRole);

            var cashier = new User("Cashier", "123456") { UserRole = cashierRole };
            _workspace.Add(cashier);
        }
